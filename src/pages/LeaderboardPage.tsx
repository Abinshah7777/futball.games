    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-16 animate-fadeIn">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-white font-display">
          Football11 <span className="gold-gradient-text">Leaderboard</span>
        </h1>
      ...
      {/* Filter Tabs */}
      <div className="flex flex-wrap items-center justify-center gap-2 p-1.5 rounded-2xl bg-stadium-900 border border-slate-800 max-w-xl mx-auto">
        {[
      ...
      <div className="glass-panel rounded-3xl border border-emerald-500/20 shadow-2xl overflow-hidden">
        
        {/* TOP 3 PODIUM DISPLAY */}
        {leaderboard.length >= 3 && (
          <div className="grid grid-cols-3 gap-2 p-6 bg-gradient-to-b from-stadium-900/90 to-stadium-950 border-b border-slate-800 text-center items-end">
            
            {/* Rank 2 - Silver */}
            <div className="p-3 rounded-2xl bg-stadium-900/80 border border-slate-700/80 space-y-2">
              <div className="w-12 h-12 rounded-full mx-auto border-2 border-slate-300 overflow-hidden shadow-lg">
              ...
              <span className="text-xs font-bold pitch-gradient-text block font-display">{leaderboard[1].score} PTS</span>
            </div>

            {/* Rank 1 - Gold */}
            <div className="p-4 rounded-2xl bg-gradient-to-b from-amber-500/20 to-stadium-900 border border-amber-500/40 space-y-2 shadow-glow-gold -translate-y-2">
              <div className="relative w-16 h-16 rounded-full mx-auto border-2 border-amber-400 overflow-hidden shadow-xl">
              ...
              <span className="text-sm font-black gold-gradient-text block font-display">{leaderboard[0].score} PTS</span>
            </div>

            {/* Rank 3 - Bronze */}
            <div className="p-3 rounded-2xl bg-stadium-900/80 border border-amber-700/50 space-y-2">
              <div className="w-12 h-12 rounded-full mx-auto border-2 border-amber-700 overflow-hidden shadow-lg">
              ...
              <span className="text-xs font-bold pitch-gradient-text block font-display">{leaderboard[2].score} PTS</span>
            </div>
          ...
          {leaderboard.map((entry, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                <span className={`w-8 h-8 rounded-xl flex items-center justify-center font-black text-xs font-display ${
                  ...
                  'bg-stadium-900 text-slate-400 border border-slate-800'
                }`}>
                  #{entry.rank}
                </span>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-400">
                    <span className="uppercase text-[10px] font-semibold text-emerald-400">{entry.gameType}</span>
                    <span>•</span>
