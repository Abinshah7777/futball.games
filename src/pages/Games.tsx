    ...
    <div className="space-y-8 pb-16 animate-fadeIn">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        <h1 className="text-3xl sm:text-5xl font-black text-white font-display">
          Football <span className="pitch-gradient-text">Game Arena</span>
        </h1>
      ...
      {/* Rules Notice */}
      <div className="max-w-3xl mx-auto p-6 rounded-2xl glass-panel border border-slate-800 space-y-3">
